        ...
        strategies = [
            {
                ...
                "cmd": [
                    ...
                    "libx264",
                    "-vf",
                    f"scale={ANCHO_VIDEO}:{ALTO_VIDEO}:force_original_aspect_ratio=decrease,pad={ANCHO_VIDEO}:{ALTO_VIDEO}:(ow-iw)/2:(oh-ih)/2",
                    "-r",
                    f"{FPS_VIDEO}",
                    "-c:a",
                    "aac",
            ...
            },
            {
                ...
                "cmd": [
                    ...
                    "libx264",
                    "-vf",
                    f"scale={ANCHO_VIDEO}:{ALTO_VIDEO}",
                    "-r",
                    f"{FPS_VIDEO}",
                    "-c:a",
                    "aac",
            ...
            {"name": "moviepy_fallback", "moviepy": True},
        ]
    else:
    ...
    for strategy in strategies:
        try:
            ...
            if strategy.get("moviepy", False):
                ...
                if os.path.exists(normalized_path) and os.path.getsize(normalized_path) > 0:
                    logger.info(
                        f"Video normalizado correctamente con estrategia: {strategy['name']}"
                    )
                    return normalized_path
